...
<!-- 					<form action="http://localhost:8082/signup" method="POST" ng-submit="authCtrl.register()" name="signupForm" class="form-horizontal">  -->
					<form ng-submit="authCtrl.register()" name="signupForm" class="form-horizontal">  					
