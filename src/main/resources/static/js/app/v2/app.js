(function() {
	...
	var app = angular.module('bookApp', [ 'ngStorage', 'ngRoute', 'ui.router' ]);
	// var app = angular.module('bookApp',['ui.router','ngStorage']);

	app.constant('urls', {
		BASE : 'http://localhost:8082/',
		AUTH_SERVICE_API : 'http://localhost:8082/api/auth/',
		BOOK_SERVICE_API : 'http://localhost:8082/api/books/',
		FILE_SERVICE_API : 'http://localhost:8082/api/files/'
	});

//	app.controller('apiCtrl', function apiCtrl($scope) {
//		$scope.menus = [ {
//			menu : 'page_01',
//			url : 'page_01.html'
//		}, {
...
//	})
	...
	// app.directive('fileModel', ['$parse', 'FileService', function ($parse,
	// FileService) {
	// return {
	// restrict: 'A',
			...
			link : function(scope, el, attrs) {
				el.bind('change', function(event) {
					...
					for (var i = 0; i < files.length; i++) {
						...
						//console.log('from #uploadFiles directive: emit event#:' + i);
					}
				});
			}
		};
