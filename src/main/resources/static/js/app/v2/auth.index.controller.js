(function () {
    ...
    function Controller($location, $scope, $rootScope, $localStorage, AuthenticationService) {
        ...
        function login() {
            ...
            AuthenticationService.login(authCtrl.loginRequest, function (result) {
                if (result === true) {
                ...
                .then(
                    ...
                    function (errResponse) {
                        ...
                        authCtrl.errorMessage = 'Error while registering user: ' +
                            usernameOrEmail + ' ' + errResponse.data.errorMessage;
                        authCtrl.successMessage = '';
                    }
                );
        }
